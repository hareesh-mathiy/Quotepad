 ...
 */
public class MyQuotesRecyclerViewFragment extends Fragment {
    ...
    public static MyQuotesRecyclerViewFragment newInstance() {
        return new MyQuotesRecyclerViewFragment();
    }
