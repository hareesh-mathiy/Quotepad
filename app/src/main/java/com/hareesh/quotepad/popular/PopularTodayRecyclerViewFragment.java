 ...
 */
public class PopularTodayRecyclerViewFragment extends Fragment {
    ...
    public static PopularTodayRecyclerViewFragment newInstance() {
        return new PopularTodayRecyclerViewFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new PopularTodayRecyclerViewAdapter(mContentItems, getContext(), mRecyclerView);
