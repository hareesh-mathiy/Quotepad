 ...
 */
public class PopularRecyclerViewFragment extends Fragment {
    ...
    public static PopularRecyclerViewFragment newInstance() {
        return new PopularRecyclerViewFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new PopularRecyclerViewAdapter(mContentItems, getContext(), mRecyclerView);
