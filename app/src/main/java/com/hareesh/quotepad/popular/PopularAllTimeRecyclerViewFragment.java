 ...
 */
public class PopularAllTimeRecyclerViewFragment extends Fragment {
    ...
    public static PopularAllTimeRecyclerViewFragment newInstance() {
        return new PopularAllTimeRecyclerViewFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new PopularAllTimeRecyclerViewAdapter(mContentItems, getContext(), mRecyclerView);
