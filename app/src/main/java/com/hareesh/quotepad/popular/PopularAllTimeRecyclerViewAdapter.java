 ...
 */
public class PopularAllTimeRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PopularAllTimeRecyclerViewAdapter(List<Object> contents, Context context, RecyclerView mRecyclerView) {
